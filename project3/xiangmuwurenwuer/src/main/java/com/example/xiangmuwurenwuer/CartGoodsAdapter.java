...
//            ImageLoader.getInstance().displayImage(entity.getBriefGoods().getSmall(), newholder.iv_image);
            ...
            newholder.ib_add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    updateNumer(entity, 1, newholder.tv_num);
                }
            });
     ...
     * 更新数量
     */
    private void updateNumer(CartGoodsEntity entity, int number, TextView tv_price) {
        ...
        entity.setGoods_num(finalNum);
        tv_price.setText(entity.getGoods_num());

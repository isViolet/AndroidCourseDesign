...
import com.example.project3.adapter.GoodsListAdapter;
import com.example.project3.entity.GoodsEntity;
import com.example.project3.utils.NetworkUtils;
...
public class GoodsListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        goodslistRecyclerview = findViewById(R.id.goodslist_recyclerview);
        goodslistSwipeRefresh = findViewById(R.id.goodslist_swipe_refresh);
        //设置列表样式
...
//        }
    ...
    private void loadGoodsListByCatId(int catId) {
        ...
        String[] good_dec = {"红富士苹果","乔纳金苹果","嘎啦苹果","黄元帅苹果","黄元帅苹果"};
        for (int i = 0; i<5;i++){
            GoodsEntity goodsEntity = new GoodsEntity();
            goodsEntity.setGoods_id(1);
            goodsEntity.setName(good_dec[i]);
            goodsEntity.setPrice((int)(Math.random() * 100) + 5);
            goodsEntity.setMktprice("acasc");
            goodsEntity.setSmall("casca");
            goodsEntity.setMkt_enable(i);
            goodsEntity.setBriefGoodsCat("casc");
            goodsEntity.setBriefBrand("asc");

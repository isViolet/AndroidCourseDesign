...
import com.example.project3.activity.ChangePWDActivity;
...
public class PersonFragment extends BaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        userImgView = view.findViewById(R.id.user_img_view);
        userName = view.findViewById(R.id.user_name);
        userLevel = view.findViewById(R.id.user_level);
        personalLogin = view.findViewById(R.id.personal_login);
        personalForLogin = view.findViewById(R.id.personal_for_login);
        personalForNotLogin = view.findViewById(R.id.personal_for_not_login);
        personMyOrder = view.findViewById(R.id.person_my_order);
        ...
        personLogoutLayout = view.findViewById(R.id.person_logout_layout);
        personMyOrder = view.findViewById(R.id.person_my_order);

        personalLogin.setOnClickListener(this);
        personMyOrder.setOnClickListener(this);
        myCollect.setOnClickListener(this);
        myAddress.setOnClickListener(this);
        myAccount.setOnClickListener(this);
        personLogoutLayout.setOnClickListener(this);
